...
using GamePlatform.Auth.Service.Validators;
...
var jwtOptions = new JwtOptions
{
    ...
    Issuer = builder.Configuration["Jwt:Issuer"] ?? "GamePlatform.Auth",
    Audience = builder.Configuration["Jwt:Audience"] ?? "GamePlatform",
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Game Platform - Auth Service API",
        Version = "v1",
